...
export const Sidebar = () => {
  ...
  "
            ...
            >
                <div className="flex flex-col h-full">
                    {/* 📌 Logo da aplicação */}
                    <div className="flex flex-col items-center p-6 border-b border-accent/75">
  ...
  />
  <span className="mt-2 text-xl font-bold text-accent">InsideOut</span>
</div>

                    {/* 📌 Informações do usuário logado */}
                    <div className="p-6 border-b border-accent/75">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-accent capitalize">{user?.type}</p>
                            </div>
                        </div>
                    </div>
      ...
      <li key={link.to}>
        ...
        >
          ...
          <link.icon
            ...
            className={`${
              isActive(link.to)
                ? 'text-accent' // cor quando ativo
                : 'text-accent group-hover:text-white' // cor quando inativo + muda no hover
            }`}
          />
          {/* Nome do link */}
          <span>{link.label}</span>
                    ...
                    {/* 📌 Botão de Logout */}
                    <div className="p-4 border-t border-accent/75">
  <button
    onClick={handleLogout}
    className="flex items-center space-x-3 w-full px-4 py-3 text-white hover:text-white hover:bg-white/10 rounded-xl transition-colors"
  >
