...
export const PublicNavbar = () => {
    ...
    const navLink = [
        ...
        { ro: '/login', label: 'Login' }
    ];

    const isActive = (path) => location.pathname === path;

    return (
        <nav className="bg-medium backdrop-blur-md border-b border-white/20 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 py-3 md:px-6 md:py-4">
                <div className="flex items-center justify-between">
                    {/* logotipo */}
                    <div className="flex items-center space-x-3 md:3 md:space-x-4">
                        <div className="relative">
                            <img
                                src="/white_logo.svg"
                                alt="logotipo site insideout"
                    ...
                    {/*Link desktop*/}
                    <div className="flex items-center space-x-3 mds:space-x-4">
                    ...
                    <div className="md:hidden flex items center ml-2 ">
                        ...
                        className="text-background hover:text-light cursor-pointer"
                        aria-label="Menu"
                        >
