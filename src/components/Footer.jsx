...
export const Footer = () => {
    return (
      <footer className="w-full text-sm bg-white backdrop-blur-lg border-white/20 text-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-7 flex flex-wrap justify-center md:justify-between items-center space-y-2 md:space-y-0">
          ...
          <div className="flex flex-wrap justify-center space-x-4">
            ...
            <a href="#" className="hover:underline">Política de Privacidade do InsideOut</a>
