 ...
 */
 ...
 export const mockApi = {
   ...
   async getReportsData(psychologistId) {
     ...
     if (completedSessions > 0) statusData.push({ name: 'Concluídas', value: completedSessions, color: '#049bb6' });
     if (canceledSessions > 0) statusData.push({ name: 'Canceladas', value: canceledSessions, color: '#fd9f1b' });
     if (sessionStarted > 0) statusData.push({ name: 'Iniciadas', value: sessionStarted, color: '#049bb6' });
     if (agendadoSessions > 0) statusData.push({ name: 'Agendadas', value: agendadoSessions, color: '#fd9f1b' });
