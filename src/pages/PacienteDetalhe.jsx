    ...
    return (
        <Card className="bg-white">
            ...
            <form onSubmit={onsubmit} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-dark/50 focus:outline-noe focus:ring-2 focus:ring-light"
                            required
                        >
                ...
                />
                <div>
                    <label className="block text-sm font-medium text-dark mb-2"> Duração em (minutos)</label>
                    <select
                        value={data.time}
                    ...
                    >
                        <option value="">Selecione um horário</option>
                        {timeSlots.map(duration => <option key={duration} value={duration}>{duration} Minutos</option>)}
                    </select>
                </div>
