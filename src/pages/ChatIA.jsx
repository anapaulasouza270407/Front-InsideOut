...
<p className="text-dark">Assistente especializada em psicologia para apoiar sua prática clínica</p>
</div>
...
<Loader2 size={16} className="animate-spin text-a" />
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          {[
            ...
            'Como lidar com pacientes TDAH?',

            'Melhores dicas para conversar com Autistas',

            'Difererença entre TDA e TDAH',
...
<button
              ...
              className="text-left p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-dark transition-colors"
